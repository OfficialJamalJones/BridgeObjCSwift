...
class CustomTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.postLabel.text = dict["title"] as? String
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "Detail" {
            ...
            if let nextViewController = segue.destination as?
                ...
                print("?")
                print("Next Controller: \(nextViewController)")
                print("Title: \(cell.postLabel.text)")
//                nextViewController.titleLabel.text = cell.postLabel.text
//                nextViewController.descriptionLabel.text = cell.body
            }
        }
